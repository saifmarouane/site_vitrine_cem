...
export const metadata: Metadata = {
  title: "Page introuvable | EnergieCompare",
  description: "La page demandee est introuvable sur EnergieCompare.",
};
                ...
                <div className="mx-auto text-center mb-9">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#0B64D8" stopOpacity="0" />
                        <stop offset="1" stopColor="#0B64D8" />
                      </linearGradient>
                      <linearGradient
