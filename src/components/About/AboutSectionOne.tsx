import { comparisonSteps } from "@/data/steps";
      ...
      <div className="container">
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative mx-auto aspect-[16/10] w-full max-w-[620px] lg:mr-0">
                <Image
                  src="/images/about/about-image.jpeg"
                  alt="about-image"
                  fill
                  className="object-contain drop-shadow-three dark:hidden dark:drop-shadow-none"
                />
                <Image
                  src="/images/about/about-image-dark.jpeg"
                  alt="about-image"
                  fill
                  className="hidden object-contain drop-shadow-three dark:block dark:drop-shadow-none"
                />
              </div>
            </div>
          </div>
