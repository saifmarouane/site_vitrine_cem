  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        {error && (
          <p className="mb-4 text-sm font-medium text-orange">{error}</p>
        )}
        {isSubmitted && (
          <p className="mb-4 text-sm font-medium text-primary">
            Demande enregistree. WhatsApp a ete ouvert.
          </p>
        )}
        <button
          disabled={isSubmitting}
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-70 dark:shadow-submit-dark"
        >
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#0B64D8" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
